...
namespace Knoq.Models
{
    ...
    public partial class RequestEventStock : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Knoq.Models.RequestEventStock_tags>? Tags { get; set; }
#nullable restore
#else
        public List<global::Knoq.Models.RequestEventStock_tags> Tags { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Knoq.Models.RequestEventStock"/> and sets the default values.
        /// </summary>
        public RequestEventStock()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Knoq.Models.RequestEventStock"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Knoq.Models.RequestEventStock CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Knoq.Models.RequestEventStock();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "tags", n => { Tags = n.GetCollectionOfObjectValues<global::Knoq.Models.RequestEventStock_tags>(global::Knoq.Models.RequestEventStock_tags.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Knoq.Models.RequestEventStock_tags>("tags", Tags);
