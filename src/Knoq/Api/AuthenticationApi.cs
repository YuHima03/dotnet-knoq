...
namespace Knoq.Api
{
    ...
    public interface IAuthenticationApiSync : IApiAccessor
    {
        ...
        ApiResponse<Object> GetCallbackWithHttpInfo(string session, string code);
    ...
    public partial class AuthenticationApi : IDisposable, IAuthenticationApi
    {
        ...
        /// <param name="code">OAuth2.0のcode</param>
        /// <returns></returns>
        public void GetCallback(string session, string code)
        {
            GetCallbackWithHttpInfo(session, code);
        }
        ...
        /// <param name="code">OAuth2.0のcode</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Knoq.Client.ApiResponse<Object> GetCallbackWithHttpInfo(string session, string code)
        {
            // verify the required parameter 'session' is set
            if (session == null)
                throw new Knoq.Client.ApiException(400, "Missing required parameter 'session' when calling AuthenticationApi->GetCallback");
            ...
            localVarRequestOptions.QueryParameters.Add(Knoq.Client.ClientUtils.ParameterToMultiMap("", "code", code));


            // make the HTTP request
            var localVarResponse = this.Client.Get<Object>("/callback", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetCallback", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        public async System.Threading.Tasks.Task<Knoq.Client.ApiResponse<Object>> GetCallbackWithHttpInfoAsync(string session, string code, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/callback", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
